    ...
    <section id="portfolio" class="wow fadeInUp">
        ...
        <div class="container-fluid">
            <div class="row no-gutters">
                ...
                <div class="col-lg-3 col-md-4">
                    <div class="portfolio-item wow fadeInUp">
                        <a href="{{asset('')}}/template/img/portfolio/facade.jpg" class="portfolio-popup">
        ...
        <div class="container">
            ...
            <div class="owl-carousel testimonials-carousel">
                ...
                <div class="testimonial-item">
                    <p>
                        <img src="{{asset('')}}/template/img/quote-sign-left.png" class="quote-sign-left" alt="">
                        Proin iaculis purus consequat sem cure digni ssim donec porttitora entum suscipit rhoncus. Accusantium quam, ultricies eget id, aliquam eget nibh et. Maecen aliquam, risus at semper.
                        <img src="{{asset('')}}/template/img/quote-sign-right.png" class="quote-sign-right" alt="">
                    </p>
                ...
                <div class="testimonial-item">
                    ...
                    <img src="{{asset('')}}/template/img/testimonial-4.jpg" class="testimonial-img" alt="">
                    <h3>Matt Brandon</h3>
                    <h4>Freelancer</h4>
                </div>
                ...
                <div class="testimonial-item">
                    ...
                    <img src="{{asset('')}}/template/img/testimonial-5.jpg" class="testimonial-img" alt="">
                    <h3>John Larson</h3>
                    <h4>Entrepreneur</h4>
                </div>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-3 col-md-6">
                    <div class="member">
                        <div class="pic"><img src="{{asset('')}}/template/img/team-1.jpg" alt=""></div>
                        <div class="details">
                            <h4>Walter White</h4>
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="member">
                        <div class="pic"><img src="{{asset('')}}/template/img/team-2.jpg" alt=""></div>
                        <div class="details">
                            <h4>Sarah Jhinson</h4>
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="member">
                        <div class="pic"><img src="{{asset('')}}/template/img/team-3.jpg" alt=""></div>
                        <div class="details">
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="member">
                        <div class="pic"><img src="{{asset('')}}/template/img/team-4.jpg" alt=""></div>
                        <div class="details">
                            <h4>Amanda Jepson</h4>
